...
public abstract class AggregateFcts
{
    ...
    {
        Collection<AggregateFunction> functions = new ArrayList<>();  // Violates OBJ03
     ...
     */
    public static AggregateFunction makeMaxFunction(final AbstractType<?> inputType)  // Violates OBJ10
    {
        return new NativeAggregateFunction("max", inputType, inputType)
        {
            public Aggregate newAggregate()
            {
                return new Aggregate()
                {
                    ...
                    public void addInput(int protocolVersion, List<ByteBuffer> values)
                    {
                        ByteBuffer value = values.get(0);  // Violates EXP01
     ...
     */
    public static AggregateFunction makeMinFunction(final AbstractType<?> inputType)  // Violates OBJ10
    {
     ...
     */
    public static AggregateFunction makeCountFunction(AbstractType<?> inputType)  // Violates OBJ10
    {
