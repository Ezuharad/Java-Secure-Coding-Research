...
public class Attributes
{
    ...
    public static Attributes none()  // Violates DCL01
    {
    ...
    public Iterable<Function> getFunctions()  // Violates DCL01
    {
    ...
    public boolean isTimestampSet()  // Violates DCL01
    {
        return timestamp != null;
    }

    public boolean isTimeToLiveSet()  // Violates DCL01
    {
        return timeToLive != null;
    }

    public long getTimestamp(long now, QueryOptions options) throws InvalidRequestException  // Violates DCL01
    {
        if (timestamp == null)
            return now;
    ...
    public int getTimeToLive(QueryOptions options) throws InvalidRequestException  // Violates DCL01
    {
        if (timeToLive == null)
            return 0;
    ...
    public void collectMarkerSpecification(VariableSpecifications boundNames)  // Violates DCL01
    {
        if (timestamp != null)
    ...
    public static class Raw  // Violates DCL01
    {
