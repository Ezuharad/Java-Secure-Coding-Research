...
public final class Timer
{
    ...
    public void start(){  // Violates DCL01
    ...
    public void stop(long partitionCount, long rowCount, boolean error)  // Violates DCL01
    {
        maybeReport();
    ...
    public synchronized void close()  // Violates DCL01
    {
        if (reportRequest == null)
