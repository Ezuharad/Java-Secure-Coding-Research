...
public class Pair<T1, T2>
{
    ...
    @Override
    public final int hashCode()  // Violates DCL01
    {
    ...
    @Override
    public final boolean equals(Object o)  // Violates DCL01
    {
    ...
    @Override
    public String toString()  // Violates DCL01
    {
        return "(" + left + "," + right + ")";
    }

    public static <X, Y> Pair<X, Y> create(X x, Y y)  // Violates DCL01
    {
