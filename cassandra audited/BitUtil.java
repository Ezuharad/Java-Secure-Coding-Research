...
final class BitUtil {
  ...
  ***/
    ...
    x = x - ((x >>> 1) & 0x5555555555555555L);  // Violates NUM01, NUM00
    x = (x & 0x3333333333333333L) + ((x >>>2 ) & 0x3333333333333333L); //  Violates NUM01, NUM00
    x = (x + (x >>> 4)) & 0x0F0F0F0F0F0F0F0FL;  // Violates NUM01, NUM00
    x = x + (x >>> 8);  // Violates NUM01, NUM00
    x = x + (x >>> 16);  // Violates NUM01, NUM00
    x = x + (x >>> 32);  // Violates NUM01, NUM00
    return ((int)x) & 0x7F;  // Violates NUM01, NUM00
  }
  ...
  public static long pop_array(long A[], int wordOffset, int numWords) {
    ...
    *
    */
    int n = wordOffset+numWords;  // Violates NUM00
    long tot=0, tot8=0;
    ...
    for (i = wordOffset; i <= n - 8; i+=8) {
      ...
      {
        long b=A[i], c=A[i+1];  // Violates NUM00
        long u=ones ^ b;  // Violates NUM01
        twosA=(ones & b)|( u & c);  // Violates NUM01
        ones=u^c;  // Violates NUM01
      }
