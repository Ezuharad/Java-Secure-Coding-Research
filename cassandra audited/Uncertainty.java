...
public class Uncertainty
{
    ...
    {
        measurements++;  // Violates NUM00
        sumsquares += value * value;  // Violates NUM00, NUM07, NUM08
        sum += value;  // Violates NUM00, NUM07, NUM08
        mean = sum / measurements;  // Violates NUM00, NUM07, NUM08, NUM02
        stdev = Math.sqrt((sumsquares / measurements) - (mean * mean));  // Violates NUM00, NUM07, NUM08
        uncertainty = (stdev / Math.sqrt(measurements)) / mean;  // Violates NUM00, NUM07, NUM08, NUM02
