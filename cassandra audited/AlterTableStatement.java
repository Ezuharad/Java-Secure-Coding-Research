...
public class AlterTableStatement extends SchemaAlteringStatement
{
    ...
    public Event.SchemaChange announceMigration(boolean isLocalOnly) throws RequestValidationException
    {
        ...
        Iterable<ViewDefinition> views = View.findAll(keyspace(), columnFamily());  // Violates EXP01

        switch (oType)
        {
            case ADD:
                assert columnName != null;
                if (cfm.isDense())  // Violates EXP01
            ...
            case DROP:
                assert columnName != null;
                if (!cfm.isCQLTable())  // Violates EXP01
            ...
            case OPTS:
                ...
                TableParams params = attrs.asAlteredTableParams(cfm.params);  // Violates EXP01
            ...
            case RENAME:
                for (Map.Entry<ColumnIdentifier.Raw, ColumnIdentifier.Raw> entry : renames.entrySet())
                {
                    ...
                    cfm.renameColumn(from, to);  // Violates EXP01
